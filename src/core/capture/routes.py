...
from src.database.models import CapturePayload, BatchCapturePayload, AuthSessionPayload, AuthFlowBlueprint
...
from src.export.postman import generate_postman_from_logs
...
async def get_auth_session():
    ...
    from src.core.replay_service import ACTIVE_TOKEN
    if ACTIVE_TOKEN:
        return ACTIVE_TOKEN
